        ...
        <div className="order-2 md:order-1 md:col-span-5 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          >
            ...
            >
              ...
              {/* Change the span inside the button to this */}
              <span className="font-[family-name:var(--font-inter)] uppercase tracking-widest text-[10px] md:text-xs font-bold text-[#1C1C1C] opacity-100">
                Book an Experience
              </span>
            </button>
          </motion.div>
