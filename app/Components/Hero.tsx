    ...
    Marv
      ...
      <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-12 gap-8 items-center relative z-10">
        ...
        <div className="order-2 md:order-1 md:col-span-5 flex flex-col items-center md:items-start text-center md:text-left">
          ...
          >
            {/* Boosted Font Weight for visibility */}
            <span className="font-[family-name:var(--font-inter)] uppercase tracking-[0.3em] md:tracking-[0.5em] text-[10px] text-[#C6A76B] font-extrabold mb-4 md:mb-6 block">
            ...
            >
              ...
              {/* Forced opacity and bold for mobile visibility */}
              <span className="font-[family-name:var(--font-inter)] uppercase tracking-widest text-[10px] md:text-xs font-black text-[#1C1C1C] !opacity-100">
                Book an Experience
              </span>
            </button>
          </motion.div>
