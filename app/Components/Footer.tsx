          ...
          <div className="grid grid-cols-2 gap-12 md:gap-24 w-full md:w-auto">
            <div className="flex flex-col items-center md:items-start">
              ...
              <ul className="font-[family-name:var(--font-inter)] text-[11px] space-y-4 uppercase tracking-[0.2em] text-[#1C1C1C]">
                <li className="hover:text-[#C6A76B] cursor-pointer transition-colors">Experience</li>
                <li className="hover:text-[#C6A76B] cursor-pointer transition-colors">Bakery</li>
                <li className="hover:text-[#C6A76B] cursor-pointer transition-colors" onClick={() => document.getElementById('booking')?.scrollIntoView({behavior: 'smooth'})}>Booking</li>
              </ul>
            </div>
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <ul className="font-[family-name:var(--font-inter)] text-[11px] space-y-4 uppercase tracking-[0.2em] text-[#1C1C1C]">
                <li className="hover:text-[#C6A76B] cursor-pointer transition-colors">Instagram</li>
                <li className="hover:text-[#C6A76B] cursor-pointer transition-colors">WhatsApp</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="w-full pt-10 border-t border-[#1C1C1C]/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-center">
            <p className="font-[family-name:var(--font-inter)] text-[9px] text-[#1C1C1C]/40 uppercase tracking-[0.3em]">
              © {currentYear} Chef Marvv. All Rights Reserved.
            </p>
